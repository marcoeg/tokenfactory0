...
export interface TokenfactoryQueryAllDenomResponse {
...
export interface TokenfactoryQueryGetDenomResponse {
  denom?: TokenfactoryDenom;
}
...
/**
 * @title tokenfactory/denom.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/marcog/tokenfactory/tokenfactory/denom
   */
  queryDenomAll = (
    query?: {
    ...
    this.request<TokenfactoryQueryAllDenomResponse, RpcStatus>({
      path: `/marcog/tokenfactory/tokenfactory/denom`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/marcog/tokenfactory/tokenfactory/denom/{denom}
   */
  queryDenom = (denom: string, params: RequestParams = {}) =>
    this.request<TokenfactoryQueryGetDenomResponse, RpcStatus>({
      path: `/marcog/tokenfactory/tokenfactory/denom/${denom}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/marcog/tokenfactory/tokenfactory/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<TokenfactoryQueryParamsResponse, RpcStatus>({
      path: `/marcog/tokenfactory/tokenfactory/params`,
      method: "GET",
      format: "json",
      ...params,
    });
